...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Album>(entity =>
        {
            ...
            entity.HasOne(d => d.AlbumSinger).WithMany(p => p.Albums)
        ...
        modelBuilder.Entity<AlbumsDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Album).WithMany(p => p.AlbumsDetails)
                .HasForeignKey(d => d.AlbumId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__AlbumsDet__Album__3A81B327");

            entity.HasOne(d => d.Song).WithMany(p => p.AlbumsDetails)
        ...
        modelBuilder.Entity<CategoriesDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.CategoriesDetails)
                .HasForeignKey(d => d.CategoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Categorie__Categ__31EC6D26");

            entity.HasOne(d => d.Song).WithMany(p => p.CategoriesDetails)
                .HasForeignKey(d => d.SongId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Follower>(entity =>
        {
            ...
            entity.HasOne(d => d.Singer).WithMany(p => p.Followers)
        ...
        modelBuilder.Entity<PlaylistsDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Playlist).WithMany(p => p.PlaylistsDetails)
                .HasForeignKey(d => d.PlaylistId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Playlists__Playl__2F10007B");

            entity.HasOne(d => d.Song).WithMany(p => p.PlaylistsDetails)
                .HasForeignKey(d => d.SongId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SharedPlaylistsDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Playlist).WithMany(p => p.SharedPlaylistsDetails)
                .HasForeignKey(d => d.PlaylistId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SharedPla__Playl__3D5E1FD2");

            entity.HasOne(d => d.User).WithMany(p => p.SharedPlaylistsDetails)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
